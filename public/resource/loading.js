...
function initSvgLogo(id) {
    ...
    <g>
        <title>Layer 1</title>
        <text style="fill:currentColor" x="150" y="325" id="svg_1" font-size="70" font-family="'Assistant'" xml:space="preserve" font-style="italic" font-weight="bold">汽车维修系统</text>
