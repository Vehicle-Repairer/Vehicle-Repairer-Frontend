<template>
    <div class="s-card flex flex-col gap-5">
        ...
        <div class="grid grid-cols-4 p-6 space-x-10">
            <div class="space-y-2">
                <div class="text-lg font-semibold text-primary s-underline ">{{ '维修项目' }}</div>
                <div>
                    <n-select v-model:value="value" :options="options" />
                </div>
            </div>
            <div class="space-y-2">
                <div class="text-lg font-semibold text-primary s-underline ">{{ '项目编号' }}</div>
                <div>
                    <n-input type="text" placeholder="可以清除" clearable />
                </div>
            </div>
            <div class="space-y-2">
                <div class="text-lg font-semibold text-primary s-underline ">{{ '工时' }}</div>
                <div>
                    <n-input type="text" placeholder="可以清除" clearable />
                </div>
            </div>
