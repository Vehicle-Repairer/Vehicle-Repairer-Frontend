    ...
    <div class="flex flex-row gap-10 w-full h-full">
      <div class="flex flex-col gap-10 w-1/2">
          ...
          >
            <div class="grid grid-cols-3 gap-4">
              ...
              <div>
                <n-form-item label="作业分类" path="repairAmount">
                  <n-select v-model:value="model.repairAmount" clearable :options="repairAmountOption" />
                </n-form-item>
              </div>
              <div>
            ...
            <div>
              <n-form-item label="故障描述" path="detailedFault">
                <n-input v-model:value="model.detailedFault" clearable placeholder="请输入故障描述" type="textarea" />
              </n-form-item>
            </div>
        ...
        <div class="s-card flex flex-col p-5 space-x-2 space-y-2">
          ...
          <n-data-table ref="dataTableInst2" :columns="columnsCar" :data="dataCar" :pagination="pagination2" size="large" />
        </div>
      </div>
