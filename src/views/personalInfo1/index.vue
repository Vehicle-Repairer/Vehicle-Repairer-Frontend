    ...
    <div class="flex flex-row gap-10 w-full">
      ...
      <div class="flex flex-col gap-10 w-2/3">
        <div class="s-card flex flex-col p-5 space-y-2">
          ...
          <n-data-table ref="dataTableInst" :columns="columnsAttorney" :data="dataAttorney" :pagination="pagination" />
        </div>
      </div>
    </div>
  </div>
...
import { addRepairItem, getMyInfo, modifyInfo, getRepairItems, getAllAttorney } from '@/apis';
